...
#------------------------------
    ...
    probdata.add_param('u',     1.0,  'u velocity')
    probdata.add_param('v',     1.0,  'v velocity')
    probdata.add_param('w',     1.0,  'w velocity')
    ...
    clawdata.upper[1] = 1.4          # yupper
    clawdata.lower[2] = 0.          # zlower
    clawdata.upper[2] = 2.          # zupper
    ...
    clawdata.bc_lower[2] = 'periodic'   # at zlower
    clawdata.bc_upper[2] = 'periodic'   # at zupper
    ...
    amrdata.refinement_ratios_z = [3, 3]
    ...
    amrdata.flag_richardson_tol = 0.5  # Richardson tolerance
