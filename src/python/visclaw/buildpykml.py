...
#  File "parser.pxi", line 1593, in lxml.etree._parseDocument (src/lxml/lxml.etr#ee.c:93318)
#  File "parser.pxi", line 1624, in lxml.etree._parseFilelikeDocument (src/lxml/#lxml.etree.c:93661)
#  File "parser.pxi", line 1506, in lxml.etree._parseDocFromFilelike (src/lxml/l#xml.etree.c:92516)
#  File "parser.pxi", line 1069, in lxml.etree._BaseParser._parseDocFromFilelike# (src/lxml/lxml.etree.c:89538)
#  File "parser.pxi", line 577, in lxml.etree._ParserContext._handleParseResultD#oc (src/lxml/lxml.etree.c:84711)
